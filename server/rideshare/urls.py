...
urlpatterns = [
	...
	url(r'^rideshare/upload_profile_license/$', views.upload_profile_license),
	url(r'^rideshare/get_profile_photo/$', views.get_profile_photo),
	url(r'^rideshare/get_license_photo/$', views.get_license_photo),
	url(r'^rideshare/notify_rider/$', views.notify_rider),
	url(r'^rideshare/get_leaderboards/$', views.get_leaderboards),
	url(r'^rideshare/confirm/$', views.user_email_confirm),
	url(r'^rideshare/confirmed/(?P<user_id>[0-9]+)/$', views.user_email_confirmed, name='confirmed'),
]